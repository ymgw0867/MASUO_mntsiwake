...
namespace mntsiwake
{
    class Entity
    {
        public struct KariKashi
        {
            ...
            public string TaxRT;       //税率 2017/08/31
        }
        ...
        public struct OutKamokuData
        {
            ...
            public string TaxKbn;           // 税区分
            public string TaxRT;            // 税率 2017/08/31
            public string TaxRTShubetsu;    // 税率種別 2019/09/25
        ...
        public class OutPutHeader
        {
            ...
            public const string kr10 = @"""CSJS222""";  // 借方税率種別 2019/09/25
            ...
            public const string ks10 = @"""CSJS322""";  // 貸方税率種別 2019/09/25
